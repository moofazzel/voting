...
const TrumpVoteButton = () => {
  return (
    <div className="flex justify-center mt-5">
      <button
        type="submit"
        className="flex   w-full md:w-[300px] sm:w-[200px]  justify-center gap-2 items-center bg-blue-500 px-6 py-2.5 text-white font-semibold hover:bg-blue-600 group rounded-md tracking-wider  text-base sm:text-xl"
      >
        <span>Vote</span>
        <svg
